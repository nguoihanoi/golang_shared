module github.com/nguoihanoi/golang_shared/warehouses/users
...
require (
	...
	github.com/nguoihanoi/golang_shared/libs/database v0.0.0-20260728152631-78d805234d84 // indirect
